...
drift_flags:
  - detected_at: "2026-08-20T09:49:42+00:00"
    ...
    status: "open"
    detail: "origin/integration/roadmap-v2 advanced through b6d52ee, but the binding semantic-enabled scorecard could not run: ${HOME}/.gcloud-kw/application_default_credentials.json is absent in this scheduler environment, and scripts/quickstart_smoke.sh at exact heads still refuses EMBEDDING_PROVIDER=vertex by requiring EMBEDDING_PROVIDER=none in .env. No pre-existing service was scored."
```
