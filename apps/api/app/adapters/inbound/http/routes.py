...
@router.post('/api/workspaces/{workspace_id}/dependencies',status_code=201)
...
@router.patch('/api/workspaces/{workspace_id}/dependencies/{dependency_id}')
def update_workspace_dependency(workspace_id:str,dependency_id:str,body:WorkspaceDependencyUpdate,db:Session=Depends(get_db)):
 ...
 db.refresh(dependency); return workspace_dependency_out(dependency)
@router.delete('/api/workspaces/{workspace_id}/dependencies/{dependency_id}',status_code=204)
...
@router.get('/api/workspaces/{workspace_id}/repositories')
...
@router.put('/api/workspaces/{workspace_id}/repositories/{repo_id}')
@router.post('/api/workspaces/{workspace_id}/repositories/{repo_id}')
...
@router.delete('/api/workspaces/{workspace_id}/repositories/{repo_id}',status_code=204)
...
@router.post('/api/repositories',status_code=202)
...
@router.post('/api/repositories/{repo_id}/reindex',status_code=202)
...
@router.get('/api/repositories/{repo_id}/status')
...
@router.get('/api/repositories/{repo_id}/symbols/{symbol_id}/code-card')
...
@router.get('/api/repositories/{repo_id}/repository-card')
...
@router.get('/api/repositories/{repo_id}/structural-cards')
...
@router.get('/api/repositories/{repo_id}/structural-cards/{kind}')
